...
$result = $gaclApi->add_object_section('System', 'system', 10, 0, 'ACO'); //Must specifiy Object Type.
 ...
 */
$result = $gaclApi->add_object('system', 'Enable - Login', 'login', 10, 0, 'ACO'); //Must specifiy Object Type.
 ...
 * add_object($sectionValue, $name, $value=0, $order=0, $hidden=0, $objectType=NULL)
 */
$result = $gaclApi->add_object_section('Users', 'users', 10, 0, 'ARO'); //Must specifiy Object Type, notice it is ARO now.
if ($result !== FALSE) {
...
$result = $gaclApi->add_object('users', 'John Doe', 'john_doe', 10, 0, 'ARO');
...
$result = $gaclApi->add_object('users', 'Jane Doe', 'jane_doe', 11, 0, 'ARO');
 ...
 *
 * addAcl($aco_array, $aro_array, $aro_group_ids=NULL, $axo_array=NULL, $axo_group_ids=NULL, $allow=1, $enabled=1, $return_value=NULL, $note=NULL, $aclId=FALSE )
 */
...
$result = $gaclApi->addAcl($aco_array, $aro_array, NULL, NULL, NULL, $allow, $enabled, $return_value, $note);
