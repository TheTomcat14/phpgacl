...
function acl_check($acoSectionValue, $aco_value, $aro_section_value, $aroValue, $axo_section_value=NULL, $axo_value=NULL, $root_aro_group_id=NULL, $root_axo_group_id=NULL) {
  global $gacl;

  return $gacl->acl_check($acoSectionValue, $aco_value, $aro_section_value, $aroValue, $axo_section_value, $axo_value, $root_aro_group_id, $root_axo_group_id);
}
